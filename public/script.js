...
window.onload = function () {
  ...
  auth.onAuthStateChanged((firebaseUser) => {
    if (firebaseUser) {
      ...
      // Auth Firebase sudah siap -> aman baca semua ref yang butuh auth != null
      muatDataLengkap();

      // [PERBAIKAN BUG]: pasang monitor kuota Firestore DI SINI (setelah auth
      // siap), bukan langsung saat script diload, agar tidak permission-denied.
